# Define horizon::generic_service
#
# This class implements basic ceilomer services.
# It is derived from https://github.com/stackforge/puppet-horizon/blob/master/manifests/generic_service.pp
#
define horizon::generic_service (
